                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-pic-zoom">
                            <img class="product-big-img" src="<?= base_url('uploads/' . $barang->gambar . '') ?>"
                                alt="">
                            <div class="zoom-icon">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                <div class="pt active"
                                    data-imgbigurl="<?= base_url('uploads/' . $barang->gambar . '') ?>"><img
                    ...
                    <div class="col-lg-6">
                        <div class="product-details">
                            ...
                            <div class="pd-desc">
                                ...
                                <hr>
                                <div class="form-group">
                                    <?= form_label('Kode Voucher', 'diskon2') ?>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="diskon2" name="diskon2"
                                            aria-label="Recipient's username" aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="button" id="btnCek"
                                                name="btnCek">Cek</button>
                                        </div>
                                    </div>
                                </div>
                                <?= form_open('buy') ?>
                                ...
                                <div class="form-group">
                                    <?= form_label('Besar diskon (%)', 'diskon') ?>
                                    <?= form_input($diskon) ?>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="co-item">
                                            ...
                                            <div class="avatar-text">
                                                ...
                                                <h5><?= $komentar->username ?>
                                                    <span><?= $komentar->created_date ?></span></h5>
...
$('document').ready(function() {
    ...
    $("#btnCek").on('click', function() {
        var $kode = $('#diskon2').val();
        var $count = 0;

        $.ajax({
            url: "<?php echo site_url("shop/getdiskon") ?>",
            type: "POST",
            data: {
                'kodeInput': $kode
            },
            success: function(hasil) {
                ...
                if ($obj.success == false) {
                    alert($obj.data);
                    $('#diskon2').addClass('is-invalid');
                    $('#diskon2').removeClass('is-valid');
                    $('#diskon').val(0);
                    diskon = 0;
                    total();
                } else {
                    alert('Voucher berhasil dimasukkan!');
                    diskon = $obj.data['besar_diskon'];
                    $('#diskon').val($obj.data['besar_diskon']);

                    total();

                    $('#diskon2').addClass('is-valid');
                    $('#diskon2').removeClass('is-invalid');
                }
            },
        });
    });
    ...
    function total() {
        var total_harga = (jumlah_pembelian * harga) - ((jumlah_pembelian * harga) * (diskon / 100)) + ongkir;;
